...
<table class="table">
    ...
    <tbody>
        ...
        <tr
            ...
            <td colspan="9"
                style="border: 1px solid #000000; text-align: -moz-center; text-align: -webkit-center; text-align: center; font-family: Arial;">
                Estandarizar el proceso de diligenciamiento de los consumos de electricidad a nivel central y
                desconcentrado
            </td>
        </tr>
        <tr style="border: 1px solid #000000;">
...
<table class="table">
    <thead>
        ...
        <tr>
            ...
            <th
                style="background-color: #AEAAAA; color: #000000; border: 1px solid #000000; text-align: -moz-center; text-align: -webkit-center; text-align: center; font-family: Arial;">
                <b>Consumo per cápita (KW) por mes </b>
            </th>
            <th
                style="background-color: #AEAAAA; color: #000000; border: 1px solid #000000; text-align: -moz-center; text-align: -webkit-center; text-align: center; font-family: Arial;">
                <b>Promedio trimestral de per cápita (KW) por mes </b>
            </th>
            <th
                style="background-color: #AEAAAA; color: #000000; border: 1px solid #000000; text-align: -moz-center; text-align: -webkit-center; text-align: center; font-family: Arial;">
                &nbsp;
